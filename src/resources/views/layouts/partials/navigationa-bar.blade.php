    ...
    <ul class="flex items-center text-sm ml-4">
        <li class="mr-2">
            <a
                ...
                class="text-gray-400 hover:text-gray-600 font-medium">Dashboard</a>
        </li>
            ...
            <div
                ...
                <form action="" class="p-4 border-b border-b-gray-100">
                    ...
                    <div class="relative w-full">
                        <input
                            type="text"
                            class="py-2 pr-4 pl-10 bg-gray-50 w-full outline-none
                                 border border-gray-100 rounded-md text-sm focus:border-blue-500"
                            placeholder="Search...">
